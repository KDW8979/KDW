...
for page_number in range(1, 5): 
    url = f"https://www.saramin.co.kr/zf_user/search?searchType=search&company_cd=0%2C1%2C2%2C3%2C4%2C5%2C6%2C7%2C9%2C10&keydownAccess=&searchword=%EA%B2%8C%EC%9E%84+%EB%B0%B1%EC%97%94%EB%93%9C&panel_type=&search_optional_item=y&search_done=y&panel_count=y&preview=y&recruitPage={page_number}&recruitSort=relation&recruitPageCount=100&inner_com_type=&show_applied=&quick_apply=&except_read=&ai_head_hunting=&mainSearch=y"
...
colormap='winter',	mask=img_mask, width=800, height=600).generate_from_frequencies(word_count)
